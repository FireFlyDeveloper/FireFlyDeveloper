...
### API & Data Services
- [Manga-API](https://github.com/FireFlyDeveloper/Manga-API) - Versatile API for manga titles, chapters, and details retrieval

### Backend & Arduino IoT
- [UPtime](https://github.com/FireFlyDeveloper/UPtime) - Node.js monitoring system with real-time device tracking and email alerts
- [ESP8266-Server-Auto-Power-Controller](https://github.com/FireFlyDeveloper/ESP8266-Server-Auto-Power-Controller) - Lightweight ESP8266 health monitoring and remote power control
- [VertexHermesProxy](https://github.com/FireFlyDeveloper/VertexHermesProxy) - Google Agent Studio OpenAI proxy for Hermes Agent
...
If you like my work and projects, you can support me here:
